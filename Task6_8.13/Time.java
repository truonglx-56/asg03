...
public class Time {
    private int hour;   // 0 - 23
      ...
      {                                                        
         setTime( h, m, s,0,0,0 ); // invoke setTime to validate time
      ...
      public void setTime( int h, int m, int s,int month,int day,int year )
      {
     ...
     public void setHour( int h )
      ...
      public String toUniversalString()
      {
         return String.format(
            "%02d:%02d:%02d", getHour(), getMinute(), getSecond(),date.toString() );
